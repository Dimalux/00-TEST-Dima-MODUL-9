...
// УВАГА!!! (01:42:40) :  до тега <script> доданий атрибут type="module". Якщо його видалити, ми НЕ ЗМОЖЕМО ІМПОРТУВАТИ !!!
// Директива type="module" паралельно запустить атрибут (поведінку) defer. Це означає, що наш скрипт-файл (src="./helpers/page-2.js") буде завантажений, але запуститься коли повністю побудується сторінка page-2.html
